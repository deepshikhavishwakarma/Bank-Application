...
<body>
	...
	<h1 style="text-align:center;">Welcome to Your BANK</h1>
		 ...
		 <%= msg!=null ? msg:"" %></h2> --%>
		 <h2 style="color:orange;"> <% out.println(msg1+" "+cb1.getCname().toUpperCase()+"<br>");%></h2>
		 <h3><% out.println("Your Current Balance is : "+cb1.getBalance()); %>
		 </h3>
        ...
        <form action="login" method="post">
            ...
            <input type="text" name="accNo" placeholder="Customer Account Number ">
            <input type="password" name="pword" placeholder="Password">
            <input type="submit" value="Login">
            <a href="Register.html">Don't have an account?<br>Register here</a>
        </form> -->
